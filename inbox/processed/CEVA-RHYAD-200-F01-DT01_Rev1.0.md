...
techniques nécessaires à la conception de la fonction **F01 -- Réception
et Expédition**.

Il constitue le document de référence permettant de définir les besoins
fonctionnels, les contraintes d'exploitation et les données de
dimensionnement associées à cette fonction.
...
-   CEVA-RHYAD-100-F01 --- Réception et Expédition
...
# 3. Produits expédiés
  ...
  Produit   Conditionnement   Température   Destination   Commentaires
  --------- ----------------- ------------- ------------- --------------

# 4. Contrôles à réception

  Contrôle   Responsable   Fréquence   Commentaires
  ---------- ------------- ----------- --------------

# 5. Flux

  Flux                 Sens   Particularités   Commentaires
  -------------------- ------ ---------------- --------------
  Matières premières                           
  Consommables                                 
  Produits finis                               
...
# 6. Équipements
  ...
  Équipement   Quantité   Particularités   Commentaires
  ------------ ---------- ---------------- --------------
